...
class __TwigTemplate_3e99c0417656c3c92003cc44aba620c8 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        ";
            // line 7
            yield (((($tmp = (isset($context["render_as_html"]) || array_key_exists("render_as_html", $context) ? $context["render_as_html"] : (function () { throw new RuntimeError('Variable "render_as_html" does not exist.', 7, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (Twig\Extension\CoreExtension::nl2br(CoreExtension::getAttribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 7, $this->source); })()), "formattedValue", [], "any", false, false, false, 7))) : (Twig\Extension\CoreExtension::nl2br($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 7, $this->source); })()), "formattedValue", [], "any", false, false, false, 7), "html", null, true))));
            yield "
    </span>
";
        } else {
...
{% endif %}
", "@EasyAdmin/crud/field/textarea.html.twig", "/home/jeremy/profane/Profane/vendor/easycorp/easyadmin-bundle/templates/crud/field/textarea.html.twig");
    }
}
